...
import com.fabrica.hutchisonspring.service.CheckoutDetailService;
...
@RestController
@RequestMapping("/api")
public class CheckoutDetailResource {
    private final CheckoutDetailService checkoutDetailService;

    public CheckoutDetailResource(CheckoutDetailService checkoutDetailService) {
        this.checkoutDetailService = checkoutDetailService;
    }

    @GetMapping("/checkoutDetails")
    public ResponseEntity<List<CheckoutDetailDTO>> getDispatchDetails(
    // @formatter:off
        ...
        Page<CheckoutDetailDTO> page = checkoutDetailService.getCheckoutDetails(shipId, travelId, bl, vehicleChassis,
